...
class Login extends Component {
    ...
    // onChange handling for username and password
    ...
    handleLogin = e => {
        ...
        // prevents from logging in with empty username or password
    ...
    register = () => {
        ...
        // prevents from registering with empty values
        if (!username || !password) {
            return;
        }
        ...
        return (
           <main className="login-container">
                <form className="login-form" onSubmit={this.handleLogin}>
                    ...
                    <label>Username: <input type="text" onChange={this.updateUsername} /> </label>
                    <label>Password: <input type="password" onChange={this.updatePassword} /> </label>
